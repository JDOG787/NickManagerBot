...
module.exports = {
    ...
    if(msg.member.hasPermission('MANAGE_NICKNAMES')) {
      ...
      Request.findById(id, (err, request) => {
        if (!err) { 
          if (request.authorId === msg.guild.ownerID) return msg.reply("I can't change that person's nickname, make sure I have enough permissions!");
      ...
      msg.reply("You don't have enough permissons to do that!");
    } 
	}
};